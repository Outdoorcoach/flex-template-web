...
export const TIME_SLOT_HOUR = 'time-slot/time';
...
export const LINE_ITEM_HOURS = 'line-item/units';
...
export const LINE_ITEM_PEOPLE_DISCOUNT = 'line-item/people-discount';
export const LINE_ITEM_HOURS_DISCOUNT = 'line-item/hours-discount';
...
export const LINE_ITEMS = [
  ...
  LINE_ITEM_PEOPLE_DISCOUNT,
  LINE_ITEM_HOURS_DISCOUNT,
];
